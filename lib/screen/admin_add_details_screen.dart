...
class AdminAddDetailScreen extends StatefulWidget {
  @override
  _AdminAddDetailScreenState createState() => _AdminAddDetailScreenState();
}

class _AdminAddDetailScreenState extends State<AdminAddDetailScreen> {
                        ...
                        Container(
                          ...
                          () async {
                            if (nameController.text.isEmpty ||
                              ...
                              final result =
                                  await addAdmin(adminModel, context);
